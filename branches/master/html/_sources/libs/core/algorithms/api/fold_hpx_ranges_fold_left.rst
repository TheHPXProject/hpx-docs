...
.. _modules_fold_hpx_ranges_fold_left_api:
...
.. doxygenfunction:: hpx::ranges::fold_left(InIter first, Sent last, T init, F f)
   :project: hpx
.. doxygenfunction:: hpx::ranges::fold_left(Rng &&rng, T init, F f)
   :project: hpx
