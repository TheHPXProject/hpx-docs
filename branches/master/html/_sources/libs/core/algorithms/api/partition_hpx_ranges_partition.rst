...
.. _modules_partition_hpx_ranges_partition_api:
...
See also:
   ...
   - :ref:`hpx::ranges::stable_partition <modules_partition_hpx_ranges_stable_partition_api>`
   - :ref:`hpx::ranges::partition_copy <modules_partition_hpx_ranges_partition_copy_api>`
