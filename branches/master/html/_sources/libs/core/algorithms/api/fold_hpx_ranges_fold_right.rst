...
.. _modules_fold_hpx_ranges_fold_right_api:
...
.. doxygenfunction:: hpx::ranges::fold_right(BidIter first, Sent last, T init, F f)
   :project: hpx
.. doxygenfunction:: hpx::ranges::fold_right(Rng && rng, T init, F f)
   :project: hpx
