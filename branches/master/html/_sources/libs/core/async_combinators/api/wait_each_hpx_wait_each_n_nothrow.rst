...
.. _modules_wait_each_hpx_wait_each_n_nothrow_api:
...
See also:
   ...
   - :ref:`hpx::wait_each <modules_wait_each_hpx_wait_each_api>`
   - :ref:`hpx::wait_each_nothrow <modules_wait_each_hpx_wait_each_nothrow_api>`
   - :ref:`hpx::wait_each_n <modules_wait_each_hpx_wait_each_n_api>`

.. doxygenfunction:: hpx::wait_each_n_nothrow
   :project: hpx
