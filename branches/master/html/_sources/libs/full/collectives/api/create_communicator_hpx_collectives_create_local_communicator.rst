...
.. doxygenfunction:: hpx::collectives::create_local_communicator(char const * basename, num_sites_arg num_sites, this_site_arg this_site, generation_arg generation, root_site_arg root_site)
   :project: hpx
