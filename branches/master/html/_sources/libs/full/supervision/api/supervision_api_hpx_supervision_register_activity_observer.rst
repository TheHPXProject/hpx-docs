...
.. doxygenfunction:: hpx::supervision::register_activity_observer(hpx::id_type const & locality, activity_callback const & callback, std::optional< std::uint64_t > epoch_filter)
   :project: hpx
.. doxygenfunction:: hpx::supervision::register_activity_observer(hpx::launch::sync_policy, hpx::id_type const & locality, activity_callback const & callback, std::optional< std::uint64_t > epoch_filter, hpx::error_code & ec)
   :project: hpx
.. doxygenfunction:: hpx::supervision::register_activity_observer(activity_callback const & callback, std::optional< std::uint64_t > epoch_filter, hpx::error_code & ec)
   :project: hpx
